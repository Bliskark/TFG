...
<div class="max-w-2xl mx-auto p-2">
  ...
  <div class="bg-red-600 rounded-lg shadow-lg p-4 border-4 border-gray-800">
    ...
    <div class="bg-gray-100 rounded-lg p-5 border-2 border-gray-800">
      ...
      <?php if(is_array(session('errors')) && count(session('errors')) > 0): ?>
        <div class="mb-4 p-3 bg-red-200 text-red-800 rounded border border-red-400">
          ...
          <ul class="list-disc list-inside">
            <?php $__currentLoopData = session('errors'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $msg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      ...
      <form action="<?php echo e(route('admin.usuarios.store')); ?>" method="POST">
        ...
        <div class="mb-4 bg-purple-100 p-4 rounded-lg border-2 border-purple-400">
          ...
          <select name="rol" id="rol" required
            ...
            <option value="lider"      <?php echo e(old('rol')==='lider'      ? 'selected' : ''); ?>>Líder de Gimnasio</option>
            <option value="alto_mando" <?php echo e(old('rol')==='alto_mando' ? 'selected' : ''); ?>>Alto Mando</option>
            <option value="campeon"    <?php echo e(old('rol')==='campeon'    ? 'selected' : ''); ?>>Campeón</option>
            <option value="user"       <?php echo e(old('rol')==='user'       ? 'selected' : ''); ?>>Entrenador</option>
          </select>
        </div>
          ...
          <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 p-4 bg-gray-100 rounded-b-lg border-2 border-yellow-400">
            <div>
              ...
              <input type="number" name="victories" id="victories" min="0"
                     value="<?php echo e(old('victories', 0)); ?>"
            ...
            <div>
              ...
              <input type="number" name="defeats" id="defeats" min="0"
                     value="<?php echo e(old('defeats', 0)); ?>"
                     class="w-full border-2 border-gray-400 rounded-lg px-3 py-2 focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-300 bg-white">
            </div>
            <div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Blisk\Desktop\pokeCombates\resources\views/admin/usuarios/create.blade.php ENDPATH**/ ?>