...
<form action="<?php echo e(route('admin.usuarios.update', $usuario->id)); ?>" method="POST" class="space-y-5 p-4">
  <?php echo csrf_field(); ?>
  ...
  <div class="pokedex-input-group">
    ...
    <div class="pokedex-input-wrapper">
      <select name="rol" class="pokedex-select">
        <option value="entrenador" <?php if($usuario->rol==='entrenador'): ?> selected <?php endif; ?>>Entrenador</option>
        <option value="lider" <?php if($usuario->rol==='lider'): ?> selected <?php endif; ?>>Líder</option>
        <option value="alto_mando" <?php if($usuario->rol==='alto_mando'): ?> selected <?php endif; ?>>Alto Mando</option>
        <option value="campeon" <?php if($usuario->rol==='campeon'): ?> selected <?php endif; ?>>Campeón</option>
        <option value="admin" <?php if($usuario->rol==='admin'): ?> selected <?php endif; ?>>Admin</option>
      </select>
    </div>
  </div>
  ...
  <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
    <div class="pokedex-input-group">
      ...
      <div class="pokedex-input-wrapper">
        <input type="number" name="victories" value="<?php echo e(old('victories', $usuario->victories)); ?>"
    ...
    <div class="pokedex-input-group">
      ...
      <div class="pokedex-input-wrapper">
        <input type="number" name="defeats" value="<?php echo e(old('defeats', $usuario->defeats)); ?>"
              class="pokedex-input" min="0">
      </div>
    </div>
    ...
    <div class="pokedex-input-group">
      ...
      <div class="pokedex-input-wrapper">
        <input type="number" name="streak" value="<?php echo e(old('streak', $usuario->streak)); ?>"
              class="pokedex-input" min="0">
      </div>
    </div>
  </div>
  ...
  <div class="flex items-center justify-between pt-4 border-t border-gray-300">
    <a href="<?php echo e(route('admin.usuarios.index')); ?>" class="pokedex-btn bg-gray-600 action-btn">
      Volver
    </a>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Blisk\Desktop\pokeCombates\resources\views/admin/usuarios/edit.blade.php ENDPATH**/ ?>